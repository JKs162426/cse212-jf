...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The last added person was taking the first place in the queue.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Tim were disappearing from the queue after 1 turn.  Tim should have been in the queue forever.
    ...
    // Defect(s) Found: No error was found when trying to get the next person from an empty queue. 
